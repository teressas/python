...
class Burger:
    ...
    def save(cls,data):
        ...
        burger_id = connectToMySQL('burgers_db').query_db(query,data)
        return burger_id

    @classmethod
    def get_all(cls):
        query = "SELECT * FROM burgers;"
        burgers_from_db =  connectToMySQL('burgers_db').query_db(query)
        burgers =[]
    ...
    def get_one(cls,data):
        ...
        burger_from_db = connectToMySQL('burgers_db').query_db(query,data)
